...
if ($result->num_rows > 0)
{
    ...
    <body>
    <div class="container">
        <h2 class="text-center text-uppercase text-primary">Update Staff Details</h2>
        <form action="staff_update.php" class="form-group" method="post">
            <table class="table table-striped">
                ...
                <tr>
                    <td colspan="2" align="center"><button type="submit" value="Update" class="btn btn-success">Update Record</button>
                        &nbsp;&nbsp;<a href="staff_search_u.php" class="btn btn-info">Back to Search</a></td>
                </tr>
            </table>
        </form>
    </div>
