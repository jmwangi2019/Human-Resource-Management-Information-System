...
if ($result->num_rows > 0)
{
    ...
    <div class="container">
        ...
        <form action="staff_delete.php" class="form-group" method="post">
            <table class="table table-striped">
                ...
                <tr>
                    <td colspan="2" align="center"><button type="submit" value="Delete" class="btn btn-danger">Delete Record</button>
